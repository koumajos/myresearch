...
More on my [Web page](https://koumajos.github.io/)

# My open-access papers

My open-access papers are stored in [LINK](https://github.com/koumajos/myresearch/tree/main/papers)

# My presentations from conferences

My presentations from conferences are stored in [LINK](https://github.com/koumajos/myresearch/tree/main/presentations)

# My posters from conferences

My posters are stored in [LINK](https://github.com/koumajos/myresearch/tree/main/posters)

# My thesises

My thesises are stored in [LINK](https://github.com/koumajos/myresearch/tree/main/thesises), however, master and bachelor thesises are in czech.
